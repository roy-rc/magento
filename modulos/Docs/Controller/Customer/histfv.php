...
class Histfv extends \Magento\Framework\App\Action\Action
{
    ...
    public function getHistorial($rut){
        ...
        //$url = "http://201.238.200.3:8000/WS/services/item/getDocHist.xsjs?rut={$rut}&fecha={$date}&tipo=FV";
        $url = "http://201.238.200.3:8000/WS/services/item/getDocHist1.xsjs?rut={$rut}&fecha={$date}&tipo=FV";
        $ch = curl_init();
