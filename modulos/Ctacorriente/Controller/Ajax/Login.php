...
namespace Customcode\Ctacorriente\Controller\Ajax;
...
class Login extends \Magento\Framework\App\Action\Action implements HttpPostActionInterface
{
	...
	try {
		...
		$logger->info('Ajax: !customerSession ');    
	        $response = [
                    'errors' => true,
                    'message' => __('Tu perfil no esta asociado a Ctacorriente, contacta al administrador del sitio para mas información.'),
                ];
	    }
